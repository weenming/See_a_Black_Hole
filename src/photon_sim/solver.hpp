 ...
 * \Delta = r^2 - R_s r + a^2
 *
 * By inserting constants of motion we can solve the differential equation
 * that the trajectory satisfies.
 */
...
class SolverRK {
 public:
  ...
  void solve(int max_step, double step_size) {
    /**
     * Assumption: at r -> infty, r, T, \Phi -> coord. of observer's flat
     * spacetime.
     *
     * see
     * https://duetosymmetry.com/tool/kerr-circular-photon-orbits/
     *
     * NOTE: G, M and C_0 are set to 1 here. R_s is thus 2
     */
    int i = 0;
